        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AirportId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Concourse_Terminal_TerminalId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Gate_Concourse_ConcourseId",
                        column: x => x.ConcourseId,
                        principalTable: "Concourse",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_Concourse_TerminalId",
                table: "Concourse",
                column: "TerminalId");

            migrationBuilder.CreateIndex(
                name: "IX_Gate_ConcourseId",
                table: "Gate",
                column: "ConcourseId");
