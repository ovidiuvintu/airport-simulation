...
public interface IAirportService
{
    ...
    Task<Result<AirportManagement.Service.Repository.Entities.Airport>> UpdateAirportAsync(AirportManagement.Service.Repository.Entities.Airport airport, CancellationToken cancellationToken);
}